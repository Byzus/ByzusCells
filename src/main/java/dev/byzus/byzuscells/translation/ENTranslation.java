...
public class ENTranslation {
    ...
    public Component EN_CELL_DELETED = Components.success("Successfully deleted cell.");
    public Component EN_PLAYER_ADDED_TO_CELL = Components.success("Successfully added player to cell.");
    public Component EN_CREATED_CELL = Components.success("Successfully created cell of number: {cellId}.");
    public Component EN_PLAYER_REMOVED_FROM_CELL = Components.success("Successfully removed player from cell.");
    public Component EN_CANNOT_FIND_PLAYER = Components.error("Cannot find player with name: {target}");
    ...
    public Component EN_YOU_MUST_BE_A_PLAYER = Components.error("You must be a player to use this command.");
